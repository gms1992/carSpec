...
import re
import pprint
from carspec.transformer import createCleanCarSpec
from carspec.mongo import saveToMongo
from carspec.carscrap.extractor import CarSpecExtractor


class CarSpecSpider(scrapy.Spider):
    name = 'CarSpecSpider'

    start_urls = ['file:///home/volanty/Documentos/carrosnaweb/fichadetalhe/fichadetalhe.{}.html'.format(c) for c in range(6000,6008)]
    ...
    def parse(self, response):
        ...
        saveToMongo(carSpec,'test','test-carspec')
